    ...
    <main className="w-full h-auto lg:py-24">
      ...
      >
          <div className="relative flex">
            <h2 className="absolute left-[-180px] lg:left-[-279px] top-[181px] lg:top-[279px] w-[400px] lg:w-[610px] h-[39px] lg:h-[52px] -rotate-90 uppercase font-normal text-[21px] lg:text-[34px] leading-[39.84px] text-center text-[#000000]">
